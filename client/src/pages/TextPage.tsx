    ...
    <div className="w-[100vw] h[80-vh] ">
      <div className="lg:px-32 md:px-7 max-sm:px-4 sm:px-6">
        <div className="flex gap-2">
          ...
          <span className="flex ">Текстовая</span>
        </div>
        <div className="justify-items-start absolute my-6">
          <h1 className="justify-items-start text-2xl relative">
            Текстовая страница
          </h1>
        </div>
        <p>
      ...
      <div className="   my-32 justify-start  text-justify lg:px-32 md:px-7 max-sm:px-4 sm:px-6  ">
        <p className=" text-start text-xs text-[#000000] text-justify ">
          Онлайн — гипермаркет товаров для дома, дачи, строительства и ремонта
          проанализировал спрос на аккумуляторные, ручные и электроинструменты
          в октябре 2021 и сравнил эти цифры с аналогичным периодом 2020 года.
          Этой осенью товары данной категории россияне покупали чаще на 38%.
